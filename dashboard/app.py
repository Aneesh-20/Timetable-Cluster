...
<style>
    ...
    .brand-header-center-layer {{
        ...
        margin-bottom: 2rem; padding: 15px; background: #0E131F;
        border: 2px solid {THEME['accent']}; border-radius: 16px; width: fit-content; margin: 0 auto 2rem auto;
    }}
...
if st.session_state.page == "home":
    ...
    # ... (Rest of your original logic for excel/manual input goes here)
    # Ensure all your logic stays inside this block
    st.write("App Content Initialized...")
